...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <p style="text-align: center; font-size: 13px;">Hak Cipta &copy; <?= date('Y'); ?> .<?= $row1['nama_app']; ?> by smekenli Team.</p>
<br><center><p>Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>MyName</a></p></center>
